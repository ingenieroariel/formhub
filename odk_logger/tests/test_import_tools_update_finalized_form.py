...
DB_FIXTURES_PATH_FINISHED_EDITED = os.path.join(CUR_DIR, 'data_from_sdcard_finished_edited')
...
class TestImportingFinalizedDatabase(MainTestCase):
    def setUp(self):
    ...
    def test_updating_unfinished(self):
        ...
        import_instances_from_zip(os.path.join(DB_FIXTURES_PATH_FINISHED_EDITED, "bulk_submission.zip"), self.user)
